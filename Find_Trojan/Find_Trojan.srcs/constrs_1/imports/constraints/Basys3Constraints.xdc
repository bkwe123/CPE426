...
# ALLOWING LOOPS
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO0/RO_LATCH_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO0/RO_MUX_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO0/SLICEX0Y0/LUT_MUX/MUX2TO1_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO0/SLICEX0Y1/LUT_MUX/MUX2TO1_OUT]



 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO1/RO_LATCH_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO1/RO_MUX_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO1/SLICEX0Y0/LUT_MUX/MUX2TO1_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO1/SLICEX0Y1/LUT_MUX/MUX2TO1_OUT]

 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO2/RO_LATCH_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO2/RO_MUX_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO2/SLICEX0Y0/LUT_MUX/MUX2TO1_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO2/SLICEX0Y1/LUT_MUX/MUX2TO1_OUT]

 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO3/RO_LATCH_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO3/RO_MUX_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO3/SLICEX0Y0/LUT_MUX/MUX2TO1_OUT]
 set_property ALLOW_COMBINATORIAL_LOOPS true [get_nets puf/PUF_FSM/RO3/SLICEX0Y1/LUT_MUX/MUX2TO1_OUT]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets {PUF_FSM/RO0/X0Y1_OUT}]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets {PUF_FSM/RO1/X0Y1_OUT}]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets {PUF_FSM/RO2/X0Y1_OUT}]
#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets {PUF_FSM/RO3/X0Y1_OUT}]
...
set_property IOSTANDARD LVCMOS33 [get_ports WRITE_ADR_SELECT_BTN]
set_property PACKAGE_PIN T18 [get_ports WRITE_EN_BTN]
	set_property IOSTANDARD LVCMOS33 [get_ports WRITE_EN_BTN]
set_property PACKAGE_PIN W19 [get_ports U_ID_WRITE_EN_BTN]
	set_property IOSTANDARD LVCMOS33 [get_ports U_ID_WRITE_EN_BTN]
set_property PACKAGE_PIN T17 [get_ports SHOW_UID]
	set_property IOSTANDARD LVCMOS33 [get_ports SHOW_UID]
set_property PACKAGE_PIN U17 [get_ports SHOW_WA]
	set_property IOSTANDARD LVCMOS33 [get_ports SHOW_WA]
...
#add_cells_to_pblock [get_pblocks pblock_RO0] [get_cells -quiet [list PUF_FSM/RO0]]
#resize_pblock [get_pblocks pblock_RO0] -add {SLICE_X40Y14:SLICE_X47Y24}
#create_pblock pblock_RO1
#add_cells_to_pblock [get_pblocks pblock_RO1] [get_cells -quiet [list PUF_FSM/RO1]]
#resize_pblock [get_pblocks pblock_RO1] -add {SLICE_X22Y110:SLICE_X33Y124}
#create_pblock pblock_RO2
#add_cells_to_pblock [get_pblocks pblock_RO2] [get_cells -quiet [list PUF_FSM/RO2]]
#resize_pblock [get_pblocks pblock_RO2] -add {SLICE_X38Y71:SLICE_X47Y81}
#create_pblock pblock_RO3
#add_cells_to_pblock [get_pblocks pblock_RO3] [get_cells -quiet [list PUF_FSM/RO3]]
#resize_pblock [get_pblocks pblock_RO3] -add {SLICE_X36Y125:SLICE_X47Y137}
